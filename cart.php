		...
		<div class="container">
			...
			<div class="table-wrap">
				<table class="table">
					...
					<td> <button name="updatecart"> Update cart </button> </td>
				...
				<div class="row">
					<div class="mt-5 cart-wrap" style="width: 100%;">
						...
						<span>Total</span>
						<span>₱ <?php echo $subtotal + $deliverfee; ?></span>
						</p>
						</div>
						<p class="justify-content-end"><a href="details.php" class="btn btn-primary py-3 px-4">Proceed to Checkout</a></p>
					</div>
				</div>
				</form>
				<script>
