                        ...
                        <div class="menus d-flex">
                            ...
                            <div class="menu-text ">
                                <div>
                                    ...
                                    <input class="chkb1" type="checkbox" name="choice1" value="Bulgogi">&nbsp
                                    Bulgogi<br>
                                    <input class="chkb1" type="checkbox" name="choice1" value="Galbi">&nbsp Galbi<br>
                                    <input class="chkb1" type="checkbox" name="choice1" value="Gochujang">&nbsp
                                    Gochujang<br>
                                    <input class="chkb1" type="checkbox" name="choice1" value="JRAMS Special">&nbsp
                                    JRAMS Special
                                    <button class="cart-button" type="button" onclick="onBeefbtn()" id="beefbtn"
                                        name="beefbtn">
                        ...
                        <div class="menus d-flex">
                            ...
                            <div class="menu-text">
                                <div>
                                    ...
                                    <input class="chkb1" type="checkbox" name="choice2" value="Bulgogi">&nbsp
                                    Bulgogi<br>
                                    <input class="chkb1" type="checkbox" name="choice2" value="Galbi">&nbsp Galbi<br>
                                    <input class="chkb1" type="checkbox" name="choice2" value="Gochujang">&nbsp
                                    Gochujang<br>
                                    <input class="chkb1" type="checkbox" name="choice2" value="JRAMS Special">&nbsp
                                    JRAMS Special
                                    <button class="cart-button" type="button" name="beefchickbtn" id="beefchickbtn"
                                        onclick="onBeefChickbtn()">
                                        <span class="add-to-cart">Add to Cart</span>
                                        <span class="added">Added</span>
                                        <i class="fas fa-shopping-cart"></i>
                                        <i class="fas fa-box"></i>
                        ...
                        <div class="menus d-flex">
                            ...
                            <div class="menu-text">
                                <div>
                                    ...
                                    <p><br>Your choice of 1 marinade: </p>
                                    <input class="chkb1" type="checkbox" name="choice3" value="Bulgogi">&nbsp
                                    Bulgogi<br>
                                    <input class="chkb1" type="checkbox" name="choice3" value="Galbi">&nbsp Galbi<br>
                                    <input class="chkb1" type="checkbox" name="choice3" value="Gochujang">&nbsp
                                    Gochujang<br>
                                    <input class="chkb1" type="checkbox" name="choice3" value="JRAMS Special">&nbsp
                                    JRAMS Special
                                    <button class="cart-button" name="porkbtn" id="porkbtn" type="button"
                                        onclick="onPorkbtn()">
                                        <span class="add-to-cart">Add to Cart</span>
                                        <span class="added">Added</span>
                                        <i class="fas fa-shopping-cart"></i>
                        ...
                        <div class="menus d-flex">
                            ...
                            <div class="menu-text">
                                <div>
                                    ...
                                    <p>Your choice of 1 marinade:</p>
                                    <input class="chkb1" type="checkbox" name="choice4" value="Bulgogi">&nbsp
                                    Bulgogi<br>
                                    <input class="chkb1" type="checkbox" name="choice4" value="Galbi">&nbsp Galbi<br>
                                    <input class="chkb1" type="checkbox" name="choice4" value="Gochujang">&nbsp
                                    Gochujang<br>
                                    <input class="chkb1" type="checkbox" name="choice4" value="JRAMS Special">&nbsp
                                    JRAMS Special
                                    <button class="cart-button" name="porkbeefbtn" id="porkbeefbtn" type="button"
                                        onclick="onPorkBeefbtn()">
                                        <span class="add-to-cart">Add to Cart</span>
                                        <span class="added">Added</span>
                                        <i class="fas fa-shopping-cart"></i>
                                        <i class="fas fa-box"></i>
                        ...
                        <div class="menus d-flex">
                            ...
                            <div class="menu-text">
                                <div>
                                    ...
                                    <p>Your choice of 1 marinade: </p>
                                    <input class="chkb1" type="checkbox" name="choice5" value="Bulgogi">&nbsp
                                    Bulgogi<br>
                                    <input class="chkb1" type="checkbox" name="choice5" value="Galbi">&nbsp Galbi<br>
                                    <input class="chkb1" type="checkbox" name="choice5" value="Gochujang">&nbsp
                                    Gochujang<br>
                                    <input class="chkb1" type="checkbox" name="choice5" value="JRAMS Special">&nbsp
                                    JRAMS Special
                                    <button class="cart-button" name="porkchickbtn" id="porkchickbtn" type="button"
                                        onclick="onPorkChickbtn()">
                                        <span class="add-to-cart">Add to Cart</span>
                                        <span class="added">Added</span>
                                        <i class="fas fa-shopping-cart"></i>
                                        <i class="fas fa-box"></i>
                        ...
                        <div class="menus d-flex">
                            ...
                            <div class="menu-text">
                                <div>
                                    ...
                                    <input class="chkb2" type="checkbox" name="choice6[]" value="Bulgogi">&nbsp
                                    Bulgogi<br>
                                    <input class="chkb2" type="checkbox" name="choice6[]" value="Galbi">&nbsp Galbi<br>
                                    <input class="chkb2" type="checkbox" name="choice6[]" value="Gochujang">&nbsp
                                    Gochujang<br>
                                    <input class="chkb2" type="checkbox" name="choice6[]" value="JRAMS Special">&nbsp
                                    JRAMS Special
                                    <button class="cart-button" name="fourfivepax" id="fourfivepax" type="button"
                                        onclick="onFourFivePaxbtn()">
                                        <span class="add-to-cart">Add to Cart</span>
                                        <span class="added">Added</span>
                                        <i class="fas fa-shopping-cart"></i>
                                        <i class="fas fa-box"></i>
                        ...
                        <div class="menus d-flex">
                            ...
                            <div class="menu-text">
                                <div>
                                    ...
                                    <p><br>Your choice of 2 marinade: </p>
                                    <input class="chkb2" type="checkbox" name="choice7[]" value="Bulgogi">&nbsp
                                    Bulgogi<br>
                                    <input class="chkb2" type="checkbox" name="choice7[]" value="Galbi">&nbsp Galbi<br>
                                    <input class="chkb2" type="checkbox" name="choice7[]" value="Gochujang">&nbsp
                                    Gochujang<br>
                                    <input class="chkb2" type="checkbox" name="choice7[]" value="JRAMS Special">&nbsp
                                    JRAMS Special
                                    <button class="cart-button" name="eighttenpax" id="eighttenpax" type="button"
                                        onclick="onEightTenPaxbtn()">
                                        <span class="add-to-cart">Add to Cart</span>
                                        <span class="added">Added</span>
                                        <i class="fas fa-shopping-cart"></i>
                                        <i class="fas fa-box"></i>
                ...
                <div class="container mb-5 mt-5">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            ...
                            <button class="cart-button" name="chapchaebtn" id="chapchaebtn" type="button"
                                onclick="onChapChaebtn()">
                                <span class="add-to-cart">Add to Cart</span>
                                <span class="added">Added</span>
                                <i class="fas fa-shopping-cart"></i>
                                <i class="fas fa-box"></i>
                        ...
                        <div class="col-md-4">
                            ...
                            <button class="cart-button" name="kimchibtn" id="kimchibtn" type="button"
                                onclick="onKimchibtn()">
                                <span class="add-to-cart">Add to Cart</span>
                                <span class="added">Added</span>
                                <i class="fas fa-shopping-cart"></i>
                        ...
                        <div class="col-md-4">
                            ...
                            <button class="cart-button" name="fishcakebtn" id="fishcakebtn" type="button"
                                onclick="onFishCakebtn()">
                                <span class="add-to-cart">Add to Cart</span>
                                <span class="added">Added</span>
                                <i class="fas fa-shopping-cart"></i>
                                <i class="fas fa-box"></i>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <button class="cart-button" name="potatobtn" id="potatobtn" type="button"
                                onclick="onPotatobtn()">
                                <span class="add-to-cart">Add to Cart</span>
                                <span class="added">Added</span>
                                <i class="fas fa-shopping-cart"></i>
                        ...
                        <div class="col-md-4">
                            ...
                            <button class="cart-button" name="ricecakebtn" id="ricecakebtn" type="button"
                                onclick="onRiceCakebtn()">
                                <span class="add-to-cart">Add to Cart</span>
                                <span class="added">Added</span>
                                <i class="fas fa-shopping-cart"></i>
                                <i class="fas fa-box"></i>
                        ...
                        <div class="col-md-4">
                            ...
                            <button class="cart-button" name="lettucebtn" id="lettucebtn" type="button"
                                onclick="onLettucebtn()">
                                <span class="add-to-cart">Add to Cart</span>
                                <span class="added">Added</span>
                                <i class="fas fa-shopping-cart"></i>
                                <i class="fas fa-box"></i>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="text-center">
                                <input type="radio" name="type1" value="plain" onclick="hideBeef(0)" checked="true">
                                Thinly Sliced Plain &nbsp&nbsp&nbsp&nbsp&nbsp
                                <input type="radio" name="type1" value="marinated" onclick="hideBeef(1)">
                                Marinated<br><br>
                            </div>
                            <div id="hide1" style="display: none;">
                                <p class="show">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Your choice of 1 marinade: </p>
                                <div style="margin-left: 104px;">
                                    <input class="chkb1" type="checkbox" name="choice8" value="Bulgogi">&nbsp
                                    Bulgogi<br>
                                    <input class="chkb1" type="checkbox" name="choice8" value="Galbi">&nbsp Galbi<br>
                                    <input class="chkb1" type="checkbox" name="choice8" value="Gochujang">&nbsp
                                    Gochujang<br>
                                    <input class="chkb1" type="checkbox" name="choice8" value="JRAMS Special">&nbsp
                                    JRAMS Special<br><br>
                                </div>
                            </div>
                            <div class="text-center">
                                <button class="cart-button" name="beefmeatbtn" id="beefmeatbtn" type="button"
                                    onclick="onBeefMeatbtn()">
                                    <span class="add-to-cart">Add to Cart</span>
                                    <span class="added">Added</span>
                                    <i class="fas fa-shopping-cart"></i>
                                    <i class="fas fa-box"></i>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="text-center mb-4">
                                <input type="radio" name="type2" value="plain" onclick="hidePork(0)" checked="true">
                                Thinly Sliced Plain &nbsp&nbsp&nbsp&nbsp&nbsp
                            ...
                            <div id="hide2" style="display: none;">
                                <p class="show">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Your choice of 1 marinade: </p>
                                <div style="margin-left: 104px;">
                                    <input class="chkb1" type="checkbox" name="choice9" value="Bulgogi">&nbsp
                                    Bulgogi<br>
                                    <input class="chkb1" type="checkbox" name="choice9" value="Galbi">&nbsp Galbi<br>
                                    <input class="chkb1" type="checkbox" name="choice9" value="Gochujang">&nbsp
                                    Gochujang<br>
                                    <input class="chkb1" type="checkbox" name="choice9" value="JRAMS Special">&nbsp
                                    JRAMS Special<br><br>
                                </div>
                            </div>
                            <div class="text-center">
                                <button class="cart-button " name="porkmeatbtn" id="porkmeatbtn" type="button"
                                    onclick="onPorkMeatbtn()">
                                    <span class="add-to-cart">Add to Cart</span>
                                    <span class="added">Added</span>
                                    <i class="fas fa-shopping-cart"></i>
                                    <i class="fas fa-box"></i>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="text-center mb-4">
                                <input type="radio" name="type3" value="plain" onclick="hideChick(0)" checked="true">
                                Thinly Sliced Plain &nbsp&nbsp&nbsp&nbsp&nbsp
                            ...
                            <div id="hide3" style="display: none;">
                                <p class="show">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Your choice of 1 marinade: </p>
                                <div style="margin-left: 104px;">
                                    <input class="chkb1" type="checkbox" name="choice10" value="Bulgogi">&nbsp
                                    Bulgogi<br>
                                    <input class="chkb1" type="checkbox" name="choice10" value="Galbi">&nbsp Galbi<br>
                                    <input class="chkb1" type="checkbox" name="choice10" value="Gochujang">&nbsp
                                    Gochujang<br>
                                    <input class="chkb1" type="checkbox" name="choice10" value="JRAMS Special">&nbsp
                                    JRAMS Special<br><br>
                                </div>
                            </div>
                            <div class="text-center">
                                <button class="cart-button" name="chickmeatbtn" id="chickmeatbtn" type="button"
                                    onclick="onChickMeatbtn()">
                                    <span class="add-to-cart">Add to Cart</span>
                                    <span class="added">Added</span>
                                    <i class="fas fa-shopping-cart"></i>
                                    <i class="fas fa-box"></i>
