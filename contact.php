...
<!--Parallax-->
	<div class="parallax" data-parallax="scroll" data-z-index="1" style="background-image: url(images/3.jpg);">
		...
		<div class="container">
			...
			<h3 style="padding-right: 220px"> Thank you for sending us an email. We'll get back to you soon.</h3>
			...
			<div class="col-md-5">
				...
				<div class="col-md-12 mb-3">
					<p>
						<span>Phone:</span> 
							<a href="tel:+639171080421" style="color: #e77e4e;">(+63)917 108 0421</a></p>
				</div>
				<div class="col-md-12 mb-3">
					<p>
						<span>Email:</span> 
							<a href="mailto:jramsresto@yahoo.com" style="color: #e77e4e;">jramsresto@yahoo.com</a></p>
				</div>
				<div class="col-md-12 mb-3">
						<p>
							<span>Page:</span>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="form-group text-center" ><br>
									<input type="submit" value="Send Message" class="btn btn-primary py-3 px-5" style="">
							</div>
					</form>
				</div>
