...
<body>
    ...
    <nav>
        ...
        <ul class="nav">
            ...
            <a class="cta-1 active" href="cart.php"><button class="shopping-cart">Cart <i
                        class="fa fa-shopping-basket fa-lg" style="display: inline-block;"></i></button></a>
        </ul>
    </nav>
    <!--End Nav-->
                        ...
                        <form action="index.php" method="POST" id="formID" class="checkout-form">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Province"
                                    value="Province (Metro Manila)" readonly="">
                            </div>
                                ...
                                <ul class="list-unstyled mb-1">
                                    <li>
                                        <label class="radio_wrap">
                                            <input type="radio" id="r1" name="sched" value="now" class="input_radio"
                                                checked="" onclick="hideSched(0)">
                                            <span>Now</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label class="radio_wrap">
                                            <input type="radio" id="r2" name="sched" value="later" class="input_radio"
                                                onclick="hideSched(1)">
                                            <span>Later</span>
                                        </label>
                                    </li>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input_wrap datepicker">
                                            ...
                                            <input type="date" id="sdate" class="form-control" name="resDate1"
                                    ...
                                    <div class="col-md-6">
                                        <div class="input_wrap clockpicker">
                                            ...
                                            <input type="time" id="stime" class="form-control" name=""
                                                min="<?php echo gmdate('H:i'); ?>" max="00:00">
                                        </div>
                                    </div>
                                </div>
                            </div>
