        ...
        <div class="row">
              <div class="column-left">
                <div class="row">
                  <div class="col-sm-4">
                    ...
                    <p style="margin-left: 20px; font-size: 14px;margin-top: 5px;">(+63)917 108 0421 <br>(+63)999 223 5950</p>
                  </div>
                  <div class="col-sm-4">
                    <i class="fa fa-map-pin fa-lg" style="display: inline-block;"></i>&nbsp&nbsp&nbspLocation
                    <p style="margin-left: 20px; font-size: 14px;margin-top: 5px;">10 R. Jabson Street, Pateros, Metro Manila</p>
                  </div>
                  <div class="col-sm-4">
                    <i class="fa fa-clock-o fa-lg" style="display: inline-block;"></i>&nbsp&nbsp&nbspOpen Monday-Sunday
              ...
              <div class="column-right">
                <div class="row">
                    <div class="col-sm-4">
                        <!--Facebook-->
                        <a href="https://www.facebook.com/pigsamgyup" class="fa fa-facebook"></a>
                    </div>
                    <div class="col-sm-4">
                        <!--Google-->
                        <a href="https://vymaps.com/PH/Pig-Me-Samgyupsal-Atbp-By-JRAMS-117948989607918/" class="fa fa-google"></a>
                    </div>
                    <div class="col-sm-4">
                        <!--Instagram-->
                        <a href="https://www.instagram.com/explore/locations/117948986274585/pig-me-samgyupsal-atbp-by-jrams/?hl=en" class="fa fa-instagram"></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="ftco-section">
        <div class="container-wrap">
            <div class="row justify-content-center mb-4">
                <h1 class="col-md-12 text-center mt-0">Welcome to Pig Me</h1>
            </div>
            <div class="row no-gutters">
                <div class="col-3">
                    <img src="images/logo.jpg" class="zoom" style="width:100%;">
                </div>
                <div class="col-3">
                    <img src="images/store.jpg" class="zoom" style="width:100%;">           
                </div>
                <div class="col-3">
                    <img src="images/store2.jpg" class="zoom" style="width:100%; height: 100%;">           
                </div>
                <div class="col-3">
                    <img src="images/store3.jpg" class="zoom" style="width:100%;">           
                </div>
            </div>
        </div>
    </section>
`   -->
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div class="one-half ftco-animate fadeInUp ftco-animated">
            ...
            <div>
                <p>PigMe is an authentic Samgyupsal Restaurant located at the heart of the Balut Capital of the Philippines , the Municipality of Pateros. The Restaurant was established way back 2016 headed by the loving couple Mr. and Mrs. Lorente. The Samgyupsal Restaurant was very popular on that year since a lot of Korean Foods was also emerging in our country. And also the fact that Filipino loves the Korean Country, they want to try their delicacies and one of this is the samgyupsal. The lovely couple decided to start a restaurant business that serves the best Samgyupsal Experience in the Municipality of Pateros and created PigMe. It serves the best tasting and most affordable unlimited Samgyupsal experience for everyone. </p>
            ...
            <div class="container">
                <div class="row justify-content-center mb-5 pb-3">
                    <div class="col-md-7 heading-section ftco-animate text-center fadeInUp ftco-animated">
                        <h2>OUR SERVICES</h2>
                        <p>UNLI SAMGYUPSAL PORK, BEEF, CHICKEN FILLET, CRAB, SHRIMPS, SALMON BELLY STRIPS, SQUID RINGS, SCALLOPS W/ COMPLETE UNLI SIDE DISHES, RICE</p>
                    </div>
                </div>
              <div class="row">
